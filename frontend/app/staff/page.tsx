...
import { listEmployees, updateEmployee, Employee } from "@/lib/api/staff";
...
const StaffContent = () => {
  ...
  const updatePermission = async (employeeId: string, section: string, field: string, value: string) => {
    ...
    const updatedPermissions = {
      ...
      [section]: {
        ...employee.permissions[section as keyof typeof employee.permissions],
        [field]: value,
      },
    };

    try {
      await updateEmployee(employeeId, { permissions: updatedPermissions });
      setEmployees(prev =>
        prev.map(emp =>
